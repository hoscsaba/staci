...
int main(int argc, char* argv[]) {
	...
	// cout << endl << " (c) C. Hos (cshos@hds.bme.hu)";
	...
	if (feladat.get_mode() == 5) {
		...
		cout << endl << endl << " Getting node/edge data...";
		cout << endl << "\telement_ID  : " << feladat.element_ID;
		cout << endl << "\tproperty_ID : " << feladat.property_ID;
		cout << endl << "\tvalue       : " << data;
		cout << endl << "\tThe value was also saved to tmp.dat." << endl << endl;
		ofstream myfile;
		myfile.open ("tmp.dat");
		myfile << data << " ";
		myfile.close();
...
// Exportalas connectivity ellenorzesre
	//----------------------------------------
	if (feladat.get_mode() == 7) {
		cout << "\n============================================================";
