...
%.o: ../%.cpp
	...
	g++ -I/usr/local/include  -O2 -g -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@"  "$<"
...
staci_calibrate: $(OBJS) $(USER_OBJS)
	g++ -o staci_calibrate $(OBJS) $(USER_OBJS) -L/usr/local/lib -L/usr/lib -lga -lm -lumfpack
