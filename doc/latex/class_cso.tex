...
\subsubsection[{\texorpdfstring{Compute\+Headloss()}{ComputeHeadloss()}}]{\setlength{\rightskip}{0pt plus 5cm}double Cso\+::\+Compute\+Headloss (
...
dp\textquotesingle{}=lambda$\ast$\+L/\+D$\ast$ro/2$\ast$v$\ast$fabs(v) \index{Cso@{Cso}!Compute\+Headloss\+Derivative@{Compute\+Headloss\+Derivative}}
\index{Compute\+Headloss\+Derivative@{Compute\+Headloss\+Derivative}!Cso@{Cso}}
\subsubsection[{\texorpdfstring{Compute\+Headloss\+Derivative()}{ComputeHeadlossDerivative()}}]{\setlength{\rightskip}{0pt plus 5cm}double Cso\+::\+Compute\+Headloss\+Derivative (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}\hypertarget{class_cso_a5f8536643bc971ca70aebef850fa53a1}{}\label{class_cso_a5f8536643bc971ca70aebef850fa53a1}


Computes the head loss derivative w.\+r.\+t. mass flow rate. 

dp\textquotesingle{}=lambda$\ast$\+L/\+D$\ast$ro/2$\ast$v$\ast$fabs(v) d dp\textquotesingle{}/dmp=lambda$\ast$\+L/\+D$\ast$ro/2$\ast$1/(ro$\ast$A)$^\wedge$2$\ast$abs(v) \index{Cso@{Cso}!Set\+\_\+friction\+\_\+model@{Set\+\_\+friction\+\_\+model}}
\index{Set\+\_\+friction\+\_\+model@{Set\+\_\+friction\+\_\+model}!Cso@{Cso}}
\subsubsection[{\texorpdfstring{Set\+\_\+friction\+\_\+model(string friction\+\_\+model)}{Set_friction_model(string friction_model)}}]{\setlength{\rightskip}{0pt plus 5cm}void Cso\+::\+Set\+\_\+friction\+\_\+model (
\begin{DoxyParamCaption}
\item[{string}]{a\+\_\+fric\+\_\+type}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}\hypertarget{class_cso_a113196b16e49417924fea36b770f4d84}{}\label{class_cso_a113196b16e49417924fea36b770f4d84}
...
\subsubsection[{\texorpdfstring{surlodas()}{surlodas()}}]{\setlength{\rightskip}{0pt plus 5cm}double Cso\+::surlodas (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
