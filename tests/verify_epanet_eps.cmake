...
if(NOT nodes MATCHES "0,R1,0,30,30,0,1")
    message(FATAL_ERROR "The reservoir base head was not applied at time zero")
endif()
if(NOT nodes MATCHES "3600,R1,0,33,33,0,1")
    message(FATAL_ERROR "The complete reservoir head pattern was not applied")
endif()
